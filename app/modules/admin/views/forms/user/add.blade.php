    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-midnightblue">
                <div class="panel-heading"><h4>{{ trans('admin::user.add') }}</h4></div>
                <div class="panel-body">
                    <p>{{ trans('admin::user.add.description') }}</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {{ Form::text('email', null, array('class'=>'form-control', 'placeholder'=>trans('admin::login.email'), 'id'=>'email', 'data-type'=>'email', 'required'=>'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {{ Form::text('first_name', null, array('class'=>'form-control', 'placeholder'=>trans('admin::account.first_name'), 'id'=>'first_name', 'data-minlength'=>'3', 'required'=>'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {{ Form::text('last_name', null, array('class'=>'form-control', 'placeholder'=>trans('admin::account.last_name'), 'id'=>'last_name', 'data-minlength'=>'3', 'required'=>'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {{ Form::password('password', array('class'=>'form-control', 'placeholder'=>trans('admin::login.password'), 'id'=>'password','data-equalto'=>'#password_confirmation', 'required'=>'required')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('admin::user.password_confirmation') }}</label>
                        <div class="col-sm-6">
                            {{ Form::password('password_confirmation', array('class'=>'form-control', 'placeholder'=>trans('admin::login.password_confirmation'), 'id'=>'password_confirmation', 'data-equalto'=>'#password', 'required'=>'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="checkbox">
                                <label>
                                    {{ Form::checkbox('activated', '1'); }} {{{ trans('admin::user.activated') }}}
                                </label>
                            </div>
                        </div>
                    </div>
